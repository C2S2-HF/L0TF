...
### This file generates Figures B.9, B.11 and B.13 in Appendix B.2.                           ###
...
## Figure B.9---------------------------
nn=seq(256, 2048, 256)
load("plot_results/aft_Blocks.RData")
png("aft_Blocks.png",   pointsize = 25, width=900, height=1100)
...
## Figure B.11---------------------------
load("plot_results/aft_Wave.RData")
rm(ResultCp)
png("aft_Wave.png",   pointsize = 25, width=900, height=1100)
op <- par(mfrow=c(1,1), mar=c(4,2,3,2))
m <- matrix(c(1:6,7,7),nrow = 4, ncol = 2, byrow = TRUE)
layout(mat = m, heights = c(0.3, 0.3, 0.3, 0.2))
tmp=c("MSE", "nknot", "dP", "dS", "dH", "time")
...
## Figure B.13---------------------------
load("plot_results/aft_Doppler.RData")
png("aft_Doppler.png",  pointsize = 22, width=1000, height=600)
op <- par(mfrow=c(1,1), mar=c(4,2,3,2))
