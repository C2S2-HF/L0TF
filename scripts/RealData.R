...
######################################################
library(zoo)
DataX <- read.csv("./data/air_hourly.csv", header = TRUE, na.strings = "N.A.")
...
## Figure 1 ----------------------------------------
png("figs/HKAQ.png",  pointsize = 12, width=1000, height=500, res = 100)
...
## Figure 12(a) ----------------------------------------
png("figs/HKAQ_Path.png",  pointsize = 20, width=1000, height=500, res=100)
op <- par(mfrow=c(1,1), mar=c(4,4,3,2))
